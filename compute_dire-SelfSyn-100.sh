...
MODEL_FLAGS="--attention_resolutions 32,16,8 --class_cond False --diffusion_steps 100 --dropout 0.1 --image_size 256 --learn_sigma True --noise_schedule linear --num_channels 256 --num_head_channels 64 --num_res_blocks 2 --resblock_updown True --use_fp16 True --use_scale_shift_norm True"
...
dire_dirs=(
    /opt/data/private/Datasets/GenImage/ADM/dire100/nature
    /opt/data/private/Datasets/GenImage/ADM/dire100/ai
    /opt/data/private/Datasets/GenImage/BigGAN/dire100/nature
    /opt/data/private/Datasets/GenImage/BigGAN/dire100/ai
    /opt/data/private/Datasets/GenImage/Midjourney/dire100/nature
    /opt/data/private/Datasets/GenImage/Midjourney/dire100/ai
    /opt/data/private/Datasets/GenImage/SDV14/dire100/nature
    /opt/data/private/Datasets/GenImage/SDV14/dire100/ai
    /opt/data/private/Datasets/GenImage/SDV15/dire100/nature
    /opt/data/private/Datasets/GenImage/SDV15/dire100/ai
    /opt/data/private/Datasets/GenImage/VQDM/dire100/nature
    /opt/data/private/Datasets/GenImage/VQDM/dire100/ai
    /opt/data/private/Datasets/GenImage/glide/dire100/nature
    /opt/data/private/Datasets/GenImage/glide/dire100/ai
    /opt/data/private/Datasets/GenImage/wukong/dire100/nature
    /opt/data/private/Datasets/GenImage/wukong/dire100/ai
)
for i in "${!domains[@]}"; do
    domain="${domains[$i]}"
    echo "$domain"
